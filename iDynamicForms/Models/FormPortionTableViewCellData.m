...
@synthesize tag, contentIdentifier, type, title, subTitle, subTitle2, intDataHolder, cellHeight, securedTextField, uiState, state, validationError, gpsEnabled, resetControlUI;
